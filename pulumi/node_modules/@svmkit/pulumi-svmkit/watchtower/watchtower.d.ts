...
export declare class Watchtower extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Watchtower;
    /**
     * Returns true if the given object is an instance of Watchtower.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Watchtower;
    readonly connection: pulumi.Output<outputs.ssh.Connection>;
    readonly environment: pulumi.Output<outputs.solana.Environment>;
    readonly flags: pulumi.Output<outputs.watchtower.WatchtowerFlags>;
    readonly notifications: pulumi.Output<outputs.watchtower.NotificationConfig>;

...
export declare class Transfer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Transfer;
    /**
     * Returns true if the given object is an instance of Transfer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Transfer;
    readonly allowUnfundedRecipient: pulumi.Output<boolean | undefined>;
    readonly amount: pulumi.Output<number>;
    readonly connection: pulumi.Output<outputs.ssh.Connection>;
    readonly recipientPubkey: pulumi.Output<string>;

...
export declare namespace agave {
    ...
    interface StartupPolicyArgs {
        waitForRPCHealth?: pulumi.Input<boolean>;
    }
    interface TimeoutConfigArgs {
...
export declare namespace firedancer {
    ...
    interface ConfigReportingArgs {
        solanaMetricsConfig?: pulumi.Input<string>;
    }
    interface ConfigSnapshotsArgs {
        fullSnapshotIntervalSlots?: pulumi.Input<number>;
...
export declare namespace genesis {
    interface BootstrapAccountArgs {
    ...
    interface PrimordialAccountArgs {
...
export declare namespace solana {
    ...
    interface StakeAccountKeyPairsArgs {
        stakeAccount: pulumi.Input<string>;
        voteAccount: pulumi.Input<string>;
    }
    interface TxnOptionsArgs {
    ...
    interface ValidatorInfoArgs {
        details?: pulumi.Input<string>;
        iconURL?: pulumi.Input<string>;
        name: pulumi.Input<string>;
        website?: pulumi.Input<string>;
    }
    interface VoteAccountKeyPairsArgs {
...
export declare namespace tuner {
    interface TunerFsParamsArgs {
        fsNrOpen?: pulumi.Input<number>;
    }
    interface TunerKernelParamsArgs {
...
export declare namespace watchtower {
    interface DiscordConfigArgs {
        webhookUrl: pulumi.Input<string>;
    }
    interface NotificationConfigArgs {
